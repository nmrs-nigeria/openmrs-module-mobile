...
public class SyncedVisitsFragment extends ACBaseFragment<SyncedVisitsContract.Presenter> implements SyncedVisitsContract.View {

    // Fragment components
    private TextView mEmptyList;
    private RecyclerView mSyncedVisitRecyclerView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Patient list config
        mSyncedVisitRecyclerView = root.findViewById(R.id.syncedPatientRecyclerView);
        mSyncedVisitRecyclerView.setHasFixedSize(true);
        mSyncedVisitRecyclerView.setAdapter(new SyncedVisitsRecyclerViewAdapter(this,
                new ArrayList<>()));
        mSyncedVisitRecyclerView.setVisibility(View.GONE);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(root.getContext());
        mSyncedVisitRecyclerView.setLayoutManager(linearLayoutManager);
    ...
    public void updateAdapter(List<Patient> patientList) {
        SyncedVisitsRecyclerViewAdapter adapter = new SyncedVisitsRecyclerViewAdapter(this, patientList);
        adapter.notifyDataSetChanged();
        mSyncedVisitRecyclerView.setAdapter(adapter);
    }
    ...
    public void updateListVisibility(boolean isVisible) {
        ...
        if (isVisible) {
            mSyncedVisitRecyclerView.setVisibility(View.VISIBLE);
     ...
     */
    public static SyncedVisitsFragment newInstance() {
        return new SyncedVisitsFragment();
    }
