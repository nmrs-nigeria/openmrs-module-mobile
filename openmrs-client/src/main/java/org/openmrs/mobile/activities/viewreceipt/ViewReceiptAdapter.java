...
public class ViewReceiptAdapter extends BaseAdapter {

    private ArrayList<ViewReceiptRowItem> singleRow;
    private LayoutInflater thisInflater;
    private Context context;

    public ViewReceiptAdapter(Context context, ArrayList<ViewReceiptRowItem> aRow) {
        this.singleRow = aRow;
        thisInflater = (LayoutInflater.from(context));
        this.context = context;
    }

    public void addListItemToAdapter(ArrayList<ViewReceiptRowItem> myRowItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewReceiptRowItem currentRow = (ViewReceiptRowItem) getItem(position);
