...
public class ViewAdjustmentAdapter extends BaseAdapter {

    private ArrayList<ViewAdjustmentRowItem> singleRow;
    private LayoutInflater thisInflater;
    private Context context;

    public ViewAdjustmentAdapter(Context context, ArrayList<ViewAdjustmentRowItem> aRow) {
        this.singleRow = aRow;
        thisInflater = (LayoutInflater.from(context));
        this.context = context;
    }

    public void addListItemToAdapter(ArrayList<ViewAdjustmentRowItem> myRowItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewAdjustmentRowItem currentRow = (ViewAdjustmentRowItem) getItem(position);
