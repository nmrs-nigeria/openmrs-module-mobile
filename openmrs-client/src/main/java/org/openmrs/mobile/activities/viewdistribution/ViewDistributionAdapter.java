...
public class ViewDistributionAdapter extends BaseAdapter {

    private ArrayList<ViewDistributionRowItem> singleRow;
    private LayoutInflater thisInflater;
    private Context context;

    public ViewDistributionAdapter(Context context, ArrayList<ViewDistributionRowItem> aRow) {
        this.singleRow = aRow;
        thisInflater = (LayoutInflater.from(context));
        this.context = context;
    }

    public void addListItemToAdapter(ArrayList<ViewDistributionRowItem> myRowItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewDistributionRowItem currentRow = (ViewDistributionRowItem) getItem(position);
