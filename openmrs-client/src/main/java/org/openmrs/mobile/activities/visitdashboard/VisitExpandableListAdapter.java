...
//                    break;
    ...
    public View getGroupView(int groupPosition, final boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        String disp = encounter.getEncounterType().getDisplay() +" (" + DateUtils.convertTime(DateUtils.convertTime(encdate), DateUtils.OPEN_MRS_REQUEST_PATIENT_FORMAT) + ")";
