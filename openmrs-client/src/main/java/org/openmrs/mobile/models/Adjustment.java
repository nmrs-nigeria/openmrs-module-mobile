...
public class Adjustment extends Model implements Serializable {
    private Gson gson=new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
    private Type itemtype = new TypeToken<List<AdjustmentItem>>(){}.getType();
    private Type attributetype = new TypeToken<List<String>>(){}.getType();
    ...
    public void pullAttributesList() {
        this.attributes = gson.fromJson(this.attributesList,attributetype);
    }

    public void setAttributesList() {
        this.attributesList = gson.toJson(attributes,attributetype);
    }
