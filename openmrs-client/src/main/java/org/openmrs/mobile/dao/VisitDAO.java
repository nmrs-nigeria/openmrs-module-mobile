...
public class VisitDAO {
    ...
    public long saveVisitLocally(Visit visit, long patientID) {
        EncounterDAO encounterDAO = new EncounterDAO();
        ObservationDAO observationDAO = new ObservationDAO();
        visit.setPatient(new PatientDAO().findPatientByID(String.valueOf(patientID)));
        long visitID = new VisitTable().insert(visit);
    ...
    public boolean updateVisitLocally(Visit visit, long visitID, long patientID) {
        EncounterDAO encounterDAO = new EncounterDAO();
        ObservationDAO observationDAO = new ObservationDAO();
        visit.setPatient(new PatientDAO().findPatientByID(String.valueOf(patientID)));
        if (visit.getEncounters() != null) {
    ...
    public Observable<List<Visit>> getExistingVisits(String start_date) {
        return createObservableIO(() -> {
            List<Visit> visits = new ArrayList<>();
            DBOpenHelper helper = OpenMRSDBOpenHelper.getInstance().getDBOpenHelper();
    ...
    public Observable<Visit> getActiveVisitByUUID(String visitUUID){
        return createObservableIO(() -> {
    ...
    public Visit getActiveLocalVisitByPatientId(Long patientId){
        LocationDAO locationDAO = new LocationDAO();
        Visit activeVisit = null;
        DBOpenHelper helper = OpenMRSDBOpenHelper.getInstance().getDBOpenHelper();
    ...
    public Visit getVisitByIDLocally(final Long visitID) {
            DBOpenHelper helper = OpenMRSDBOpenHelper.getInstance().getDBOpenHelper();
            Visit visit = null;
            LocationDAO locationDAO = new LocationDAO();
    ...
    public Long getVisitsIDByDate( long patientID, String startDate) {
            DBOpenHelper helper = OpenMRSDBOpenHelper.getInstance().getDBOpenHelper();

            String where = String.format("%s = ? AND %s = ?", VisitTable.Column.PATIENT_KEY_ID,VisitTable.Column.START_DATE);
            String[] whereArgs = new String[]{Long.toString(patientID),startDate};
    ...
    public Observable<List<Encountercreate>> getLocalEncounterByPatientID(final Long patientID) {
        return createObservableIO(() -> {
